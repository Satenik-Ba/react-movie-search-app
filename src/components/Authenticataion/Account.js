  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <h3 className={classes.span}>Email: {userEmail}</h3>
        <h3 className={classes.span}>Username: {userName}</h3>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText id="alert-dialog-description">
                ...
                history will be gone forever and you won't be able to access it
                again.
              </DialogContentText>
            </DialogContent>
            <DialogActions>
